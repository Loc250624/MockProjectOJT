...
public interface QuizRepository extends JpaRepository<Quiz, Integer> {
    ...
    @Query("select q from Quiz q join fetch q.lesson l join fetch l.course c where q.id = :quizId")
    Optional<Quiz> findByIdForAttemptStart(@Param("quizId") Integer quizId);
}
