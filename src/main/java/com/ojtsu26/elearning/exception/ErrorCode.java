...
public enum ErrorCode {
    ...
    CURRENT_PASSWORD_INCORRECT(400, HttpStatus.BAD_REQUEST, "Current password is incorrect"),
    PASSWORD_POLICY_VIOLATION(400, HttpStatus.BAD_REQUEST, "New password does not satisfy the password policy"),
    PASSWORD_CONFIRMATION_MISMATCH(400, HttpStatus.BAD_REQUEST, "Password confirmation does not match"),
